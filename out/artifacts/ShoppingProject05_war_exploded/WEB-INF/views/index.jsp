...
<head>
    ...
    <title>后台管理系统</title>
    <link rel="stylesheet" type="text/css" href="./resources/menu/easyui/1.3.4/themes/default/easyui.css" />
    <link rel="stylesheet" type="text/css" href="./resources/menu/css/wu.css" />
    <link rel="stylesheet" type="text/css" href="./resources/menu/css/icon.css" />
    <script type="text/javascript" src="./resources/menu/js/jquery-1.8.0.min.js"></script>
    <script type="text/javascript" src="./resources/menu/easyui/1.3.4/jquery.easyui.min.js"></script>
    <script type="text/javascript" src="./resources/menu/easyui/1.3.4/locale/easyui-lang-zh_CN.js"></script>
</head>
    ...
    <div class="easyui-accordion" data-options="border:false,fit:true">
        <div title="快捷菜单" data-options="iconCls:'icon-application-cascade'" style="padding:5px;">
            <ul class="easyui-tree wu-side-tree">
                <li iconCls="icon-chart-organisation"><a href="javascript:void(0)" data-icon="icon-chart-organisation" data-link="" iframe="0">菜单导航</a></li>
                <li iconCls="icon-users"><a href="javascript:void(0)" data-icon="icon-users" data-link="toAdminList" iframe="0">用户管理</a></li>
        ...
        <div title="系统设置" data-options="iconCls:'icon-wrench'" style="padding:5px;">
            <ul class="easyui-tree wu-side-tree">
                <li iconCls="icon-chart-organisation"><a href="javascript:void(0)" data-icon="icon-chart-organisation" data-link="list" iframe="0">菜单管理</a></li>
                <%--<li iconCls="icon-users"><a href="javascript:void(0)" data-icon="icon-users" data-link="temp/layout-3.html" iframe="0">导航标题</a></li>--%>
                <%--<li iconCls="icon-user-group"><a href="javascript:void(0)" data-icon="icon-user-group" data-link="temp/layout-3.html" iframe="0">导航标题</a></li>--%>
                <%--<li iconCls="icon-book"><a href="javascript:void(0)" data-icon="icon-book" data-link="temp/layout-3.html" iframe="0">导航标题</a></li>--%>
                <%--<li iconCls="icon-cog"><a href="javascript:void(0)" data-icon="icon-cog" data-link="temp/layout-3.html" iframe="0">导航标题</a></li>--%>
